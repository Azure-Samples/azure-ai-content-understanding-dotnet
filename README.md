...
|-----------------------------|----------------------------------|-------------|
| [ContentExtraction](ContentExtraction/) | [ContentExtractionService.cs](ContentExtraction/Services/ContentExtractionService.cs) | In this sample, we demonstrate how the Content Understanding API can help you obtain semantic information from your files. For example, OCR with tables in documents, audio transcription, and face analysis in video. |
| [FieldExtraction](FieldExtraction/)   | [FieldExtractionService.cs](FieldExtraction/Services/FieldExtractionService.cs) | This sample shows how to create an analyzer to extract fields from your files. For example, invoice amounts in documents, number of people in an image, names mentioned in audio, or summaries of videos. You can customize the fields by creating your own analyzer template. |
| [Classifier](Classifier/) | [ClassifierService.cs](Classifier/Services/ClassifierService.cs) | This sample demonstrates how to (1) create a classifier to categorize documents, (2) create a custom analyzer to extract specific fields, and (3) combine classifiers and analyzers to classify, optionally split, and analyze documents in a flexible processing pipeline. |
| [AnalyzerTraining](AnalyzerTraining/) | [AnalyzerTrainingService.cs](AnalyzerTraining/Services/AnalyzerTrainingService.cs) | If you want to further boost performance for field extraction, you can train the model by providing a few labeled samples to the API. Note: This feature is currently available for document scenarios only. |
| [Management](Management/)      | [ManagementService.cs](Management/Services/ManagementService.cs) | This sample demonstrates how to create a minimal analyzer, list all analyzers in your resource, and delete analyzers you no longer need. |
| [BuildPersonDirectory](BuildPersonDirectory/)      | [BuildPersonDirectoryService.cs](BuildPersonDirectory/Services/BuildPersonDirectoryService.cs) | This sample demonstrates how to enroll people's faces from images and build a Person Directory. |
